...
return [
    ...
    'conference_discount' => [
        'many_percents' => 'Значение не может быть больше 100',
    ...
    'max' => [
        ...
        'strip_tags' => 'Количество символов в значении поля :attribute не может превышать :max',
    ],
    ...
    'phone' => [
        'digits' => 'Номер телефона должен содержать от 7 до 15 цифр',
    ],
    ...
    'slug' => [
        'regex' => 'Недопустимые символы. Разрешены буквы латинского алфавита, цифры, дефис и нижнее подчеркивание',
    ],
