                ...
                <div class="white-block__inner">
                    <nav class="white-block__breadcrumbs breadcrumbs">
                        <ul class="breadcrumbs__list">
                            ...
                            <li class="breadcrumbs__item"><a href="{{ route('single', ['subject' => $subject, 'single' => $single]) }}" class="breadcrumbs__link">{{ $single }}</a></li>
                            <li class="breadcrumbs__item"><span class="breadcrumbs__current">{{ $country }}</span>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div class="countries">
                        <a class="_active-link" href="">{{ $country }} (<span>1</span>)</a>
            ...
            <div class="subject-result__container">
                <div class="subject-result__items">
                    <div class="subject-result__item">
                        <div class="subject-result__block">
                            <h2 class="subject-result__title title-bg">
                                {{ $country }}
                            </h2>
                            <a href="">
                                Все перечисленные конференции в {{ $country }}</a>
                        </div>
