...
@section('title', __('my/events/update.title'))
        ...
        <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__item">
				<a href="{{ route('conference.show', $conference->slug) }}" class="breadcrumbs__link">
					<span>{{ $conference->title_ru }}</span>
				</a>
            </li>
            <li class="breadcrumbs__item"><span class="breadcrumbs__current">Редактирование</span>
            </li>
        </ul>
    </nav>

    <h1 class="edit-content__title">Редактировать мероприятие</h1>
    ...
    <form action="#" class="edit-content__form form" @select-callback.camel.document="select" @submit.prevent="submit"
        ...
        <div class="form__row" :class="form.invalid('title_ru') && '_error'">
            ...
            <input id="c_1" class="input" autocomplete="off" type="text" name="title_ru"
                placeholder="Название мероприятия" x-model="form.title_ru"
        ...
        <div class="form__row" :class="form.invalid('title_en') && '_error'">
            ...
            <input id="c_2" class="input" autocomplete="off" type="text" name="title_en" placeholder="Event name"
        ...
        <div class="form__row" :class="form.invalid('format') && '_error'">
            ...
            <select name="format" data-scroll="500" data-class-modif="format" data-name="format">
                <option value="national" @if ('national' === $conference->format) selected @endif>Российское / национальное
                </option>
            ...
            <div class="form__line">
                <template x-for="organizer, id in form['co-organizers']">
                    <div class="form-list" :class="form.invalid(`co-organizers.${id}`) && '_error'">
                        ...
                        <button class="button button_outline" type="button" @click="remove(id)">Убрать
                            соорганизатора</button>
                    </div>
                </template>
        ...
        <div id="address" class="form__row" :class="form.invalid('address') && '_error'" x-data="{
            ...
            <input id="c_7" class="input" autocomplete="off" type="text" name="form[]"
                placeholder="Полный адрес" x-model="form.address" @input.debounce.1000ms="form.validate('address')">
        ...
        <div class="form__row" :class="form.invalid('description_ru') && '_error'">
            ...
            <textarea id="t_1" autocomplete="off" name="description_ru" placeholder="Описание" class="input _small"
        ...
        <div class="form__row" :class="form.invalid('description_en') && '_error'">
            ...
            <textarea id="t_1" autocomplete="off" name="description_en" placeholder="Описание" class="input _small"
        ...
        <div class="form__row _two">
            ...
            <div class="form__line" :class="form.invalid('thesis_edit_until') && '_error'">
                ...
                <input id="thesis_edit_until" class="input" autocomplete="off" type="date" placeholder="__.__.____"
