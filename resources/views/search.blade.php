...
@section('title', 'Поиск по календарю')
                ...
                <div class="white-block__inner">
                    <nav class="white-block__breadcrumbs breadcrumbs">
                        <ul class="breadcrumbs__list">
                            ...
                            <li class="breadcrumbs__item"><span class="breadcrumbs__current">Поиск по ключевой фразе</span></li>
                        </ul>
                    </nav>
                    <form action="#" class="white-block__form form form_col_two">
                        <div class="form__column">
                            <input class="form__input input" autocomplete="off" type="text"
